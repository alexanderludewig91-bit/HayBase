...
export const metadata: Metadata = {
  title: "HayBase - Finanzverwaltung",
  description: "Persönliche Finanzverwaltung und Haushaltsbuch",
...
export const viewport: Viewport = {
  width: "device-width",
  initialScale: 1,
  // maximumScale und userScalable entfernt, da sie nicht empfohlen werden
  // und Accessibility-Probleme verursachen können
  themeColor: [
  ...
  return (
    <html lang="de" className="h-full">
      <head>
        ...
        <meta name="apple-mobile-web-app-title" content="HayBase" />
